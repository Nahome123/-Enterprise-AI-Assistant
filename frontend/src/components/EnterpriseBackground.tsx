    ...
    <Box
      ...
      sx={{
        ...
        "&::before": {
          ...
          inset: "-20%",
          background:
            "radial-gradient(circle at 18% 24%, rgba(11, 61, 145, 0.13), transparent 28%), radial-gradient(circle at 76% 18%, rgba(1, 126, 132, 0.11), transparent 24%), radial-gradient(circle at 62% 82%, rgba(99, 102, 241, 0.08), transparent 30%)",
        ...
        "&::after": {
          ...
          opacity: 0.32,
          backgroundImage:
            "linear-gradient(120deg, rgba(11, 61, 145, 0.08) 1px, transparent 1px), linear-gradient(30deg, rgba(1, 126, 132, 0.08) 1px, transparent 1px)",
        ...
        return (
          <Box
            ...
            sx={{
              ...
              p: isLarge ? 1.75 : 1.25,
              borderRadius: 2.5,
              bgcolor: isLarge ? "rgba(255, 255, 255, 0.72)" : "rgba(255, 255, 255, 0.58)",
